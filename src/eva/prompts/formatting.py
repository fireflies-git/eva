...
def build_formatting_section() -> str:
    return (
        ...
        "is actually intended. Keep ordinary prose lowercase by default. For a correction, "
        "warning, or key contrast, uppercase one to three important words or a short phrase "
        "when it helps, but never write all-caps prose. Preserve meaningful capitalization in "
        "proper nouns, acronyms, commands, URLs, code, and quoted or blockquoted text. "
        "Use uppercase as emphasis, not shouting, and keep disagreement direct and calm. "
